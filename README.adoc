...
`podman run --rm --env-file credentials --volume "${PWD}":/data ghcr.io/vshn/asciidoctor-confluence-exporter:1.0 --wiki=https://wiki.url --output=output 123 45 6789 --verbose`
